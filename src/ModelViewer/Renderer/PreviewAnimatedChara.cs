...
{
    public class PreviewAnimatedChara : Sample
    {
        ...
        private AnimatedSkeleton currentSkeletonFrame;
        private DatDigger.Sections.Animation.MtbSection mtbSection;
        ...
        protected override void OnInitialize()
        {
            ...
            currentSkeletonFrame = new AnimatedSkeleton(this.globalSettings.BaseFrame, mtbSection);
            this.globalSettings.CurrentFrame = currentSkeletonFrame;
        ...
        protected override void OnUpdate()
        {
            ...
            if (!isPaused)
            {
                currentSkeletonFrame.Update(FrameDelta);
            }
        }
    }
}
